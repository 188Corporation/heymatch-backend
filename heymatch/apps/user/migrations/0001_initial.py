    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invitation_code', models.CharField(editable=False, max_length=5, unique=True)),
                ...
                ('job_title', models.CharField(blank=True, choices=[('college_student', 'College Student'), ('employee', 'Employee'), ('practitioner', 'Practitioner'), ('self_employed', 'Self Employed'), ('part_time', 'Part Time'), ('businessman', 'Businessman'), ('etc', 'Etc')], default=None, max_length=32, null=True)),
                ...
                ('point_balance', models.IntegerField(default=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expected_verification_datetime', models.DateTimeField(default=heymatch.apps.user.models.auto_expected_verification_datetime)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_photo_rejected_reason', models.CharField(blank=True, default=None, max_length=125, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(blank=True, db_index=True, max_length=30, null=True)),
                ('invitation_code', models.CharField(db_index=True, editable=False, max_length=5)),
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=128, null=True, region=None)),
                ('gender', models.CharField(blank=True, choices=[('m', 'Male'), ('f', 'Female')], default=None, max_length=1, null=True)),
                ('birthdate_dayofyear_internal', models.PositiveSmallIntegerField(default=None, editable=False, null=True)),
                ('birthdate', birthday.fields.BirthdayField(blank=True, default=None, null=True)),
