...
class GroupV2(models.Model):
    ...
    class GroupWhoWeAreTag(models.TextChoices):
        ...
        A_LOT_OF_SHYNESS = ("A_LOT_OF_SHYNESS", "🙈 수줍음 많아요/rgba(217,225,239,1.0)")
        ...
        WE_ARE_KING = ("WE_ARE_KING", "👑 우리가 왕이야/rgba(217,225,239,1.0)")
    ...
    class GroupWantToMeetTag(models.TextChoices):
        ...
        WE_LIKE_SOUP = ("WE_LIKE_SOUP", "🍲 국물안주 고고/rgba(217,225,239,1.0)")
        LETS_PLAY_ALCOHOL_GAME = (
            "LETS_PLAY_ALCOHOL_GAME",
            "🎮 술게임해요/rgba(217,225,239,1.0)",
        )
        LETS_TALK = ("LETS_TALK", "💬 차분히 대화/rgba(217,225,239,1.0)")
        WE_EAT_ANYTHING = ("WE_EAT_ANYTHING", "🤔 암거나 먹어요/rgba(217,225,239,1.0)")
        WE_EAT_CHICKEN = ("WE_EAT_CHICKEN", "🍗 치킨 먹어요/rgba(217,225,239,1.0)")
        LETS_PLAY_HOT = ("LETS_PLAY_HOT", "🔥 화끈하게 놀자/rgba(217,225,239,1.0)")
        PLAY_UNTIL_END = ("PLAY_UNTIL_END", "💪 끝까지 달려요/rgba(217,225,239,1.0)")
        PLAY_SIMPLE_UNTIL_FIRST = (
            "PLAY_SIMPLE_UNTIL_FIRST",
            "🍻가볍게 1차만/rgba(217,225,239,1.0)",
        )
        DRINK_MAKGULI = ("DRINK_MAKGULI", "☂️ 비올땐 막걸리/rgba(217,225,239,1.0)")
    ...
    # Notification
    notified_to_update_meetup_date_after_one_day = models.BooleanField(default=False)
    notified_to_update_meetup_date_after_three_day = models.BooleanField(default=False)
