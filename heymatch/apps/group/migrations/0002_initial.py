...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='buyer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='purchased_group_buyer', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='groupprofilephotopurchased',
            name='seller',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='purchased_group_seller', to='group.groupv2'),
        ),
        migrations.AddField(
