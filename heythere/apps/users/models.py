...
class User(AbstractUser):
    phone_number = PhoneNumberField(_("Phone number of User"), null=True, blank=True, unique=True)
    birth_year = IntegerField(_("Birth Year of User"), blank=True, null=True, validators=[validate_birth_year])
    gender = models.IntegerField(_("Gender of User"), blank=True, null=True, choices=GENDER_CHOICES)
    height_cm = models.IntegerField(_("Height(cm) of User"), blank=True, null=True, validators=[validate_height_cm])
